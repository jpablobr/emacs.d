...
(custom-set-faces
 ...
 '(erb-delim-face ((t (:background "black" :foreground "blue" :weigth bold))))
 '(erb-exec-face ((t (:background "black" :foreground "white" :weight bold))))
 '(erb-exec-delim-face ((t (:background "black" :foreground "red" :weight bold))))
 '(erb-out-face ((t (:background "black" :foreground "white" :weight bold ))))
 '(erb-out-delim-face ((t (:background "#666666") :foreground "red" :weight bold)))
 '(erb-comment-face ((t (:background "#666666" :foreground "red" :weight bold))))
 '(erb-comment-delim-face ((t (:background "#666666" :foreground "red" :weight bold)))))
