...
(defface asciidoc-document-title-face
  `((((class color) (background dark))
     (:foreground "#656555" :bold t :underline t :height 1.3 :inherit variable-pitch))
...
(defface asciidoc-chapter-face
  `((((class color) (background dark))
     (:foreground "#cc9393" :bold t :underline t :height 1.2 :inherit variable-pitch))
    (((class color) (background light))
     (:foreground "#cc9393" :bold t :underline t :height 1.2 :inherit variable-pitch))
    (t (:weight bold :inherit variable-pitch)))
...
(defface asciidoc-section-face
  `((((class color) (background dark))
     (:foreground "#dfaf8f" :bold t :underline t :height 1.1 :inherit variable-pitch))
    (((class color) (background light))
     (:foreground "#dfaf8f" :bold t :underline t :height 1.1 :inherit variable-pitch))
    (t (:weight bold :inherit variable-pitch)))
...
(defface asciidoc-subsection-face
  `((((class color) (background dark))
     (:foreground "#e0cf9f" :bold t :underline t :height 1.0 :inherit variable-pitch))
    (((class color) (background light))
     (:foreground "#e0cf9f" :bold t :underline t :height 1.0 :inherit variable-pitch))
    (t (:weight bold)))
...
(defface asciidoc-subsubsection-face
  `((((class color) (background dark))
     (:foreground "#94bff3" :underline t :height 1.0 :inherit variable-pitch))
    (((class color) (background light))
     (:foreground "#94bff3" :underline t :height 1.0 :inherit variable-pitch))
    (t (:weight bold)))
...
(defface asciidoc-paragraph-face
  `((((class color) (background dark))
     (:foreground "#5c888b" :bold t :inherit variable-pitch))
    (((class color) (background light))
     (:foreground "#7cb8bb" :bold t :inherit variable-pitch))
...
(defface asciidoc-mono-face
  `((t (:foreground "#8c5353" :family "courier new")))
  "Face for AsciiDoc markup (monospaced text)."
  :group 'asciidoc-faces)

(defface asciidoc-list-number-face
  `((t (:foreground "#7f9f7f" :bold t :family "courier new")))
  "Face for AsciiDoc list items."
  :group 'asciidoc-faces)

(defface asciidoc-emph-face
  `((t (:foreground "#9fc59f" :slant italic :inherit variable-pitch)))
...
(defface asciidoc-escape-face
  `((((class color) (background dark))
     (:foreground "#dcdccc" :background "Yellow"))
    (((class color) (background light))
     (:foreground "#dcdccc" :background "Yellow"))
    (t (:weight bold)))
