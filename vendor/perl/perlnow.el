...
;; Version: $Id: perlnow.el,v 1.314 2009/10/06 04:16:09 doom Exp doom $
;; Keywords:
...
and \\[perlnow-setter-prefix]."
  ...
  (let (
        ...
        (getter (concat perlnow-getter-prefix field))
        (setter (concat perlnow-setter-prefix field))
        )
  (insert (concat
           "\n"
           "=item " getter "\n"
           "\n"
           "Getter for object attribute " field "\n"
           "\n"
           "=cut" "\n"
           "\n"
           "sub " getter " {" "\n"
  ...
  (insert (concat
           ...
           "=item " setter                         "\n"
           "\n"
           "Setter for object attribute " field    "\n"
           "\n"
           "=cut"                                  "\n"
           "\n"
           "sub " setter " {"                      "\n"
