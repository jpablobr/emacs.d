    ...
    (if (null (jdwp-process jdwp))
      ...
      (let* ((protocol     (jdwp-get-protocol name))
		...
		(let ((inhibit-eol-conversion t)
		  ...
		  (jdwp-trace "coding system:%s" coding-system-for-write)
		  (jdwp-trace "process coding system:%s" (process-coding-system (jdwp-process jdwp)))
		  (jdwp-trace "sending command packed:%s" (jdwp-string-to-hex command-packed 100))
