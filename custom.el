...
(custom-set-faces
 ...
 '(compilation-column-number ((t (:inherit violet))))
 ...
 '(font-lock-constant-face ((t (:foreground "color-34"))))
 ...
 '(markdown-header-face-1 ((t (:foreground "brightmagenta"))))
 ...
 '(sh-heredoc ((t (:foreground "color-34"))))
